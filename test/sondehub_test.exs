defmodule SondehubTest do
  ...
  test " set position is string" do
    ...
    assert Sondehub.Listener.set_position(%{lng: 123,lat: 456,alt: 78}) ==  {:ok,%{lng: 123,lat: 456,alt: 78}}
  ...
  Sondehub.Listener.validate_gps_coordinates([-180,-90,10])
  Sondehub.Listener.validate_gps_coordinates([180,90,10])
  Sondehub.Listener.validate_gps_coordinates([181,91,10])
  Sondehub.Listener.validate_gps_coordinates([-181,-91,10])
  Sondehub.Listener.validate_gps_coordinates([0,0,10])

  Sondehub.Listener.validate_gps_coordinates([])
  end
end
